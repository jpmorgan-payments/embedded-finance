...
export interface UpdateClientRequestSmbdo {
   ...
   * @minItems 0
   */
  addParties?: CreatePartyRequestInline & UpdatePartyRequestInline[];
  consumerDevice?: ConsumerDevice;
  /**
   * @minItems 0
   * @maxItems 200
...
export type ParentPartyIdInQueryParameter = PartyId;
...
export type ClientIdQueryParameter = ClientId;
