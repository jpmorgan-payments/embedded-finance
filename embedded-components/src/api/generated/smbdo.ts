...
>(
  ...
  TContext
> => {
  const mutationOptions = getSmbdoUpdateClientLegacyMutationOptions(options);
...
>(
  ...
  TContext
> => {
  const mutationOptions = getUpdatePartyLegacyMutationOptions(options);
...
>(
  ...
  TContext
> => {
  const mutationOptions = getSmbdoPostSessionsMutationOptions(options);
...
>(
  ...
  TContext
> => {
  const mutationOptions = getSmbdoPostRecommendationsMutationOptions(options);
