...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      // regardless. Disabled triggers stay unfocusable because Radix sets the
      // `disabled` attribute, which overrides tabIndex. Placed before {...props}
      // so consumers can still override.
      tabIndex={0}
      {...props}
    >
      {children}
