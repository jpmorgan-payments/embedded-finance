...
const buttonVariants = cva(
  'eb-inline-flex eb-font-extrabold eb-items-center eb-rounded-button eb-text-button eb-font-md eb-button eb-justify-center eb-gap-2 eb-whitespace-nowrap eb-ring-offset-background eb-transition-colors focus-visible:eb-outline-none focus-visible:eb-ring-2 focus-visible:eb-ring-ring focus-visible:eb-ring-offset-2 active:eb-translate-y-0.25 disabled:eb-pointer-events-none disabled:eb-opacity-50 [&_svg]:eb-pointer-events-none [&_svg]:eb-size-4 [&_svg]:eb-shrink-0',
  {
    variants: {
      variant: {
        default:
          'eb-bg-primary eb-text-primary-foreground eb-rounded-md hover:eb-bg-primary-hover hover:eb-drop-shadow-md active:eb-bg-primary-active eb-font-button-primary',
        destructive:
