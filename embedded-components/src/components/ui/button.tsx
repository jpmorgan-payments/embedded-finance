...
const buttonVariants = cva(
  'eb-inline-flex eb-items-center eb-justify-center eb-gap-2 eb-whitespace-nowrap eb-rounded-button eb-text-sm eb-font-medium eb-ring-offset-background eb-transition-colors eb-texttransform-btn focus-visible:eb-outline-none focus-visible:eb-ring-2 focus-visible:eb-ring-ring focus-visible:eb-ring-offset-2 active:eb-translate-y-0.25 disabled:eb-pointer-events-none disabled:eb-opacity-50 [&_svg]:eb-pointer-events-none [&_svg]:eb-size-4 [&_svg]:eb-shrink-0',
  {
    variants: {
      variant: {
        default:
