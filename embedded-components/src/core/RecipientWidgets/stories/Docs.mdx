...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Visual display style for accounts
      </td>
    </tr>
    <tr>
      <td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Handler called for each user interaction event. Use for RUM/analytics integration
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Lifecycle hooks for action tracking (e.g., Dynatrace enterAction/leaveAction)
      </td>
    </tr>
  </tbody>
</table>
