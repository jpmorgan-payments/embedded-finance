...
<Meta title="Core/ClientDetails" of={ClientDetailsStories} />
...
<Canvas of={ClientDetailsStories.Default} />

### Controls

<Controls of={ClientDetailsStories.Default} />

## Accordion Mode

Full detail view with collapsible sections, similar to the onboarding review experience.

<Canvas of={ClientDetailsStories.AccordionView} />

## Cards Mode

Information grouped into visual cards in a responsive grid layout.

<Canvas of={ClientDetailsStories.CardsView} />
...
<Canvas of={ClientDetailsStories.Loading} />

### Error State

Displays error message when client fetch fails.

<Canvas of={ClientDetailsStories.Error} />
