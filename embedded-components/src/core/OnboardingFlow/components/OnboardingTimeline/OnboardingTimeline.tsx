...
export const OnboardingTimeline: React.FC<OnboardingTimelineProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Filter out hidden sections so connecting line logic uses correct indices */}
      {sections
        .filter((s) => getItemStatus(s.id) !== 'hidden')
        .map((section) => {
                        ...
                        className={cn(
                          ...
                          (() => {
                            const visible = sections.filter(
                              (s) => getItemStatus(s.id) !== 'hidden'
                            );
                            const currentIndex = visible.findIndex(
                              (s) => s.id === section.id
                            );
                            const prevSection = visible[currentIndex - 1];
                      ...
                      <span
                        className={cn(
                          ...
                          (() => {
                            ...
                            const nextSection = visible[currentIndex + 1];
                            ...
                            <div className="eb-relative eb-z-20 eb-flex eb-flex-col eb-items-center">
                              ...
                              section.steps.length - 1 ? (
                                ...
                                (() => {
                                  ...
                                  const currentSectionIndex = visible.findIndex(
                                    (s) => s.id === section.id
                                  );
                                  const nextSection =
