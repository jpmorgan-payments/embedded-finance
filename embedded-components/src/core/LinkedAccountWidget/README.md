...
- **linked_account_link_started**: User opens the link account dialog
- **linked_account_link_completed**: Account successfully linked
- **linked_account_verify_started**: User opens the verification dialog
- **linked_account_verify_completed**: Account successfully verified
