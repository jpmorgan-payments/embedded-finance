...
- 📋 View all linked accounts with their statuses
- ➕ Add new accounts through a guided form
- ✅ Verify microdeposits to activate accounts
- 🔄 Manage account lifecycle (active, inactive, rejected)
...
```
Create Account → MICRODEPOSITS_INITIATED → READY_FOR_VALIDATION → ACTIVE/REJECTED
```
