...
import * as FlowContextModule from '../../context/FlowContext';
...
vi.mock('../../context/FlowContext', async () => {
  const actual = await vi.importActual('../../context/FlowContext');
  return {
    ...actual,
...
const renderComponent = (
  ...
  return render(
    <QueryClientProvider client={queryClient}>
      ...
      >
        <OnboardingOverviewContext.Provider value={onboardingContext}>
