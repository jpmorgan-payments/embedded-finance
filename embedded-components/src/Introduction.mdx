...
<div className="feature-card">
  <h3 style={{ marginTop: 0, color: '#1A7B99' }}>🏦 OnboardingWizardBasic</h3>
  <p>
...
<div className="feature-card">
  <h3 style={{ marginTop: 0, color: '#2CB9AC' }}>💳 OnboardingFlow</h3>
  <p>
...
<div className="feature-card">
  <h3 style={{ marginTop: 0, color: '#1A7B99' }}>💰 MakePayment</h3>
  <p>
...
<div className="feature-card">
  <h3 style={{ marginTop: 0, color: '#2CB9AC' }}>👥 Recipients</h3>
  <p>
...
<div className="feature-card">
  <h3 style={{ marginTop: 0, color: '#1A7B99' }}>🏦 Accounts</h3>
  <p>
...
<div className="feature-card">
  <h3 style={{ marginTop: 0, color: '#2CB9AC' }}>🔗 LinkedAccountWidget</h3>
  <p>
...
<div className="feature-card">
  <h3 style={{ marginTop: 0, color: '#1A7B99' }}>📊 TransactionsDisplay</h3>
  <p>
...
| --------------------- | ------------- | --------------- | -------------- | ------------- |
| OnboardingWizardBasic | ✅ Production | ✅ Complete     | ✅ Complete    | ✅ Complete   |
| OnboardingFlow        | ✅ Production | ✅ Complete     | ✅ Complete    | ✅ Complete   |
| MakePayment           | 🧪 Testing    | ✅ Complete     | 🧪 In Progress | ✅ Complete   |
| Recipients            | ✅ Production | ✅ Complete     | ✅ Complete    | ✅ Complete   |
| Accounts              | 🧪 Testing    | ✅ Complete     | 🧪 In Progress | ✅ Complete   |
| LinkedAccountWidget   | ✅ Production | ✅ Complete     | ✅ Complete    | ✅ Complete   |
| TransactionsDisplay   | 🧪 Testing    | ✅ Complete     | 🧪 In Progress | ✅ Complete   |
