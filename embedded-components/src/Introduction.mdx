...
<div className="feature-card">
  <h3 style={{ marginTop: 0 }}>🔗 Link External Bank Account</h3>
  <p>
...
<div className="feature-card">
  <h3 style={{ marginTop: 0 }}>👥 Recipients Management</h3>
  <p>
...
<div className="feature-card">
  <h3 style={{ marginTop: 0 }}>💰 Make Payouts</h3>
  <p>
...
<div className="feature-card">
  <h3 style={{ marginTop: 0 }}>📊 Transaction History & Management</h3>
  <p>
...
<div className="feature-card">
  <h3 style={{ marginTop: 0 }}>🏦 Accounts Management</h3>
  <p>
