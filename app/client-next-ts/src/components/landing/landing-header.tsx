        ...
        <div className="flex items-center justify-between h-14 sm:h-16">
          <div className="flex items-center">
            <Link to="/" className="flex items-center">
              <div className="flex items-center">
                <div className="w-6 h-6 sm:w-8 sm:h-8 bg-jpm-brown rounded-page-sm flex items-center justify-center mr-2 sm:mr-3">
                  <span className="text-jpm-white font-semibold text-xs sm:text-page-small">
                    EF
                  </span>
                </div>
                <div className="flex flex-col">
                  <span className="font-semibold text-jpm-brown text-sm sm:text-lg leading-none">
                    Embedded Finance
                  </span>
          ...
          <div className="md:hidden">
            ...
            >
              ...
              <div className="peer-checked:block hidden absolute top-full left-0 right-0 bg-jpm-white border-b border-jpm-gray-200 shadow-lg">
