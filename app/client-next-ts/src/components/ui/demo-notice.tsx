...
export const DemoNotice = () => {
  return (
    <div className="fixed bottom-2 left-1/2 transform -translate-x-1/2 z-50 max-w-xl w-auto bg-sp-brand shadow-lg rounded-lg px-3 py-2 flex items-center gap-2 opacity-95 hover:opacity-100 transition-opacity flex-nowrap min-w-0">
