...
> **Note:**  
> This document is mainly for agents and LLMs to follow when implementing translations,  
> formatting dates/numbers/currency, or handling locale-specific content. Humans  
...
Internationalization and localization patterns for multi-locale support. This skill provides comprehensive guidance on translation patterns, locale-aware formatting, and handling locale-specific content for en-US, fr-CA, and es-US locales.
