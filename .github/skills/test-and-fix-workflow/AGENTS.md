...
> **Note:**  
> This document is mainly for agents and LLMs to follow when running tests and  
> fixing failures systematically in the embedded-components repository. Humans  
...
Automated workflow for running tests and fixing failures systematically. This skill provides comprehensive guidance on the systematic workflow for running tests, analyzing failures, and fixing issues in priority order.
