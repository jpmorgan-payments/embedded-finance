...
> **Note:**  
> This document is mainly for agents and LLMs to follow when running commands,  
> scripts, or terminal operations on Windows. Humans may also find it useful,  
...
Windows PowerShell command patterns for terminal operations. This skill provides comprehensive guidance on PowerShell syntax, command chaining, file operations, and development workflow commands for Windows environments.
